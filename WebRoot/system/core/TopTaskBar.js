...
Ext.extend(MC.TopTaskBar, Ext.util.Observable, {
    ...
    init : function(){
    	Ext.Ajax.request({
    		url:'login/login.do?method=getMenu',
    		callback:this.menuInit,
    		scope:this
    	})
    	var browser = this;
    	//模块菜单
		...
		this.sysMemuPanel = new MC.MenuPanel({
	    	...
	    	items:[{
					...
					{text:'个人设置',id:'preferences',innerView:'navigation',disabled:true,/*scope:this,*/handler:browser.menuClick/*function(){
						this.desk.createSysWindow({id:'set',title:'系统设置'}).show();}*/
					},
					{text:'挂机锁',scope:this,handler:function(){this.desk.lock();}},
	    			...
	    			{text:'帮助',scope:this,handler:function(){
	    				//this.desk.createSysWindow({id:'help',title:'帮助和支持中心'}).show();
