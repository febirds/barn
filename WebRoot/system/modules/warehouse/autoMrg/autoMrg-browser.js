	...
	prepareCMConfig : function(c) {
 	...
 	qQuery : function(btn){		
		...
		var param={logName:logName,zhName:zhName,start : 0,limit : 15};			
 		this.getStore('autoMrg').setLink('temp');
 		this.getStore('autoMrg').load({params:param});
 	}
 });
