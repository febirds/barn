	...
	prepareCMConfig : function(c) {
 	...
 	qQuery : function(btn){		
		...
		var param={logName:logName,zhName:zhName,start : 0,limit : 15};			
 		this.getStore('paramMrg').setLink('temp');
 		this.getStore('paramMrg').load({params:param});
 	}
 });
